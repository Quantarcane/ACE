...
<command>
    ...
    <execution-context>
        <research-integration-workflow>workflow.xml</research-integration-workflow>
        <integration-solution-template>integration-solution-template.xml</integration-solution-template>
