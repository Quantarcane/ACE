...
/**
 * map-pattern skill script — Entry point for all ace-tools operations
 * needed by the map-pattern skill.
 *
 * Subcommands:
 *   init               Environment detection for the map-pattern workflow
 *
...
/**
 * Environment detection for the pattern workflow.
 *
